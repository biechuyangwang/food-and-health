...
window.HDATA = {
  ...
  DISEASES: [
    { id: 't2dm', name: '2型糖尿病', page: 'disease-metabolic.html#s1',
      ...
      red_flag: '血糖≥16.7mmol/L 伴恶心呕吐、呼吸深快（酮症酸中毒征兆）；意识改变；严重低血糖处理后不缓解；足部伤口不愈——立即就医。',
      src: ['S15', 'S1'] },
    { id: 'dyslipidemia', name: '血脂异常', page: 'disease-metabolic.html#s2',
      ...
      red_flag: '活动后胸痛胸闷、突发一侧肢体无力或言语不清（中风征兆）——立即就医；已服降脂药者不可因「食疗见效」自行停药。',
      src: ['S17', 'S1'] },
    { id: 'hypertension', name: '高血压', page: 'disease-metabolic.html#s3',
      ...
      red_flag: '血压≥180/120mmHg 伴头痛、视物模糊、胸痛或气促——高血压急症，立即就医；任何情况下不可自行停药或加量。',
      src: ['S16', 'S10'] },
    { id: 'obesity', name: '超重与肥胖', page: 'disease-metabolic.html#s4',
      ...
      red_flag: 'BMI≥32.5 或已合并糖尿病/高血压/睡眠呼吸暂停——建议就医评估综合治疗；节食出现闭经、脱发、心悸、明显乏力——停止极端节食并就医。',
      src: ['S19', 'S1'] },
    { id: 'gout', name: '高尿酸血症与痛风', page: 'disease-metabolic.html#s5',
      ...
      red_flag: '关节突发红肿热痛——48小时内就医规范抗炎（不要热敷按摩）；发热、多关节发作、腰痛血尿（尿酸性肾结石）——立即就医。',
      src: ['S18'] },
    { id: 'fattyliver', name: '非酒精性脂肪性肝病', page: 'disease-metabolic.html#s6',
      ...
      red_flag: '皮肤巩膜黄染、腹胀腹围增大（腹水）、下肢水肿、皮肤易瘀斑、嗜睡意识改变——立即就医；确诊后应定期评估肝纤维化（FIB-4/弹性超声）。',
      src: ['S21', 'S1'] },
    { id: 'gastritis', name: '慢性胃炎与功能性消化不良', page: 'disease-gi.html#s1',
      ...
      red_flag: '呕血或黑便（柏油样便）、进行性消瘦、吞咽困难、不明原因贫血、上腹痛规律改变——立即就医查胃镜。',
      src: ['S1', 'S12'] },
    { id: 'constipation', name: '便秘', page: 'disease-gi.html#s2',
      ...
      red_flag: '便血（尤其暗红或黑便）、排便习惯突然改变、消瘦、贫血、有肠癌家族史——就医肠镜；便秘+腹胀呕吐停止排气——肠梗阻可能，立即就医。',
      src: ['S1', 'S20'] },
    { id: 'diarrhea', name: '急性腹泻与口服补液', page: 'disease-gi.html#s3',
      ...
      red_flag: '血便、持续高热、频繁呕吐无法进水、尿量明显减少/口渴剧烈、精神萎靡、婴幼儿与老人及免疫低下者——立即就医；腹泻超过2天不缓解就医。',
      src: ['S25'] },
    { id: 'anemia', name: '缺铁性贫血', page: 'disease-gi.html#s4',
      ...
      red_flag: '血红蛋白<60g/L、心悸气短明显、孕期任何程度贫血、儿童贫血伴发育迟缓——就医；确诊缺铁性贫血务必排查病因（便潜血、妇科、胃肠镜）。',
      src: ['S26', 'S20'] },
    { id: 'megaloblastic', name: '巨幼细胞性贫血（B12/叶酸缺乏）', page: 'disease-gi.html#s5',
      ...
      red_flag: '手足麻木、平衡障碍、记忆减退等神经症状+贫血貌——尽快就医；备孕/孕早期叶酸补充遵产科医嘱。',
      src: ['S20', 'S26'] },
    { id: 'immunity', name: '免疫与呼吸道感染恢复', page: 'disease-gi.html#s6',
      ...
      red_flag: '呼吸困难、血氧下降、持续高热>3天、意识改变、婴幼儿精神差拒食——立即就医；普通感冒不需抗生素。',
      src: ['S1', 'S34', 'S20'] },
    { id: 'osteoporosis', name: '骨质疏松', page: 'disease-gi.html#s7',
      ...
      red_flag: '轻微跌倒/弯腰负重后骨折、身高变矮>3cm或突发驼背加重——就医（椎体骨折）；确诊骨质疏松后单靠补钙不够，需规范药物治疗。',
      src: ['S27', 'S20'] }
  ],
