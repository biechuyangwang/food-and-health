...
window.HDATA = {
  ...
  SOURCES: {
    ...
    S40: { type: 'guide', title: '《全民健身指南》及总局官网解读（体育活动方式五分类 / 强度分级 / 运动处方）', org: '国家体育总局', publisher: '人民体育出版社', year: 2017 },
    S41: { type: 'guide', title: '《健身气功·八段锦》标准功法（总局健身气功管理中心组织编创）及官方教学演练视频', org: '国家体育总局健身气功管理中心', publisher: '人民体育出版社', year: 2003 },
    S42: { type: 'guide', title: '第九套广播体操（2011年8月8日发布：预备节＋8节徒手动作，总时长约4分15秒）', org: '国家体育总局', publisher: '', year: 2011 },
    S43: { type: 'guide', title: '《国家体育锻炼标准》（2013年修订：6～69周岁，速度/力量/耐力/灵敏/柔韧五类身体素质测验）', org: '国家体育总局 / 教育部 / 全国总工会等', publisher: '', year: 2013 }
  },
  ...
  /* ---------- 标准运动动作库（第 7 章） ----------
     依据国家体育总局《全民健身指南》(2017)、《健身气功·八段锦》、第九套广播体操、
     《国家体育锻炼标准》(2013) 等口径整理；器械力量动作规范另参考 ACSM/AND 立场声明(S28)。
     frames = 关键帧序列（循环插值播放），每帧为 11 个关节点 [x,y]（画布 100×100，y 向下，
     地面 y≈91）：[头顶, 颈, 骨盆, 左肘, 左手, 右肘, 右手, 左膝, 左脚, 右膝, 右脚]。
     prop：mat 垫子 / bar 横杆 / box 测量箱 / dumbbell 哑铃 / rope 跳绳。
     video 仅收录国家体育总局官网等官方稳定链接（需联网访问）。 */
  EXERCISES: [
    /* —— 有氧运动 —— */
    { id: 'walk', name: '健身走', cat: 'aero', part: '心肺 · 全身', eq: '无器械', level: 1, intensity: '中', view: 'side', dur: 2.4, prop: null, video: null,
      brief: '《全民健身指南》中等强度有氧的代表项目（约相当于快走 6 千米/小时的节奏），入门零门槛。',
      cues: ['抬头挺胸收腹，目视前方，不低头看手机', '以肩为轴前后摆臂，屈肘约 90°，手自然半握', '步幅比日常散步略大，脚跟→脚掌滚动落地', '强度自测：能正常说话但略气喘'],
      mistakes: ['含胸驼背边走边刷手机', '步幅过小「拖步走」，心率上不来', '只数步数不看强度——闲庭信步式漫步≠健身走'],
      dose: '每次持续 ≥10 分钟，每天累计 30～60 分钟；每周 150～300 分钟中等强度', src: ['S40'],
      frames: [
        [[54,16],[53,28],[50,49],[57,34],[62,38],[46,36],[42,45],[59,68],[68,91],[43,71],[36,90]],
        [[54,16],[53,28],[50,49],[46,36],[42,45],[57,34],[62,38],[43,71],[36,90],[59,68],[68,91]]
      ] },
    { id: 'jog', name: '慢跑', cat: 'aero', part: '心肺 · 下肢', eq: '跑鞋', level: 2, intensity: '中～大', view: 'side', dur: 2.0, prop: null, video: null,
      brief: '指南中等强度有氧代表（6～8 千米/小时）；8 千米/小时以上即属大强度跑步。',
      cues: ['身体略前倾，肩臂放松，屈肘约 90° 前后摆动', '小步快频，落地轻缓（常见 160～180 步/分）', '呼吸有节奏，如「三步一吸、两步一呼」', '初期可用「快走＋慢跑」交替，逐步延长跑段'],
      mistakes: ['跨大步「刹车式」脚跟重落地，膝踝冲击大', '憋气冲刺，忽快忽慢', '出现关节疼痛仍坚持——应减速或改快走'],
      dose: '每次 20～60 分钟；每周 150～300 分钟中等强度，或 75～150 分钟大强度', src: ['S40'],
      frames: [
        [[55,14],[54,26],[50,47],[56,32],[63,35],[46,33],[40,43],[61,62],[67,80],[41,68],[33,85]],
        [[55,14],[54,26],[50,47],[46,33],[40,43],[56,32],[63,35],[41,68],[33,85],[61,62],[67,80]]
      ] },
    { id: 'rope', name: '跳绳', cat: 'aero', part: '心肺 · 协调', eq: '跳绳', level: 2, intensity: '大', view: 'front', dur: 1.6, prop: 'rope', video: null,
      brief: '《国家体育锻炼标准》速度素质测验项目之一，也是耗时短、效率高的大强度有氧。',
      cues: ['前脚掌起跳落地，跳起 2～4 厘米即可，屈膝缓冲', '手腕摇绳，大臂贴近躯干', '节奏均匀，呼吸自然', '新手从 30 秒/组 × 多组开始，组间休息'],
      mistakes: ['跳得过高、落地沉重（膝踝易受伤）', '全脚掌或脚跟落地', '用整条手臂大幅抡绳'],
      dose: '30秒～1分钟/组 × 3～5组，组间歇 1～2 分钟；属大强度，计入每周 75 分钟大强度目标', src: ['S43', 'S40'],
      frames: [
        [[50,15],[50,27],[50,47],[38,40],[33,52],[62,40],[67,52],[44,63],[42,78],[56,63],[58,78]],
        [[50,18],[50,30],[50,53],[38,40],[33,52],[62,40],[67,52],[45,71],[44,91],[55,71],[56,91]]
      ] },
    /* —— 力量练习 · 指南非器械/器械示例 —— */
    { id: 'pushup', name: '俯卧撑', cat: 'strength', part: '胸 · 肩 · 上臂后侧', eq: '无器械', level: 2, intensity: '中', view: 'side', dur: 3.0, prop: 'mat', video: null,
      brief: '指南「非器械力量练习」代表动作，练胸大肌、肩前部与肱三头肌。',
      cues: ['双手略宽于肩，从头到踝保持一条直线', '下落至胸部离地约一拳，肘约 45° 朝向后方', '核心收紧，推起时呼气', '做不动标准式：先做跪姿或上斜（推墙/推桌）'],
      mistakes: ['塌腰撅臀，腰先累而不是胸累', '大臂完全展平成「一字」，肩关节压力大', '只做半程，幅度不完整'],
      dose: '10～15次/组 × 2～3组（10～20RM 口径），组间休息 1～2 分钟，隔天练习', src: ['S40'],
      frames: [
        [[78,41],[73,45],[45,64],[71,66],[71,87],[69,65],[69,87],[30,75],[14,86],[29,76],[13,87]],
        [[78,59],[73,62],[45,76],[62,76],[71,87],[60,75],[69,87],[30,81],[14,86],[29,82],[13,87]]
      ] },
    { id: 'squat', name: '自重深蹲', cat: 'strength', part: '臀 · 大腿 · 核心', eq: '无器械', level: 1, intensity: '中', view: 'front', dur: 3.2, prop: null, video: null,
      brief: '下肢力量的基础动作，臀腿与核心协同发力，是国民体能训练的标志性练习。',
      cues: ['双脚与肩同宽或略宽，脚尖略外展', '像「向后坐椅子」一样下蹲，髋膝同步弯曲', '膝盖方向始终与脚尖一致，脚跟不离地', '双臂前平举帮助平衡，蹲至大腿与地面接近平行'],
      mistakes: ['膝盖向内扣', '弓背低头看地', '重心前移、脚跟离地'],
      dose: '10～15次/组 × 2～3组，组间休息 1～2 分钟，隔天练习', src: ['S40'],
      frames: [
        [[50,17],[50,29],[50,50],[40,40],[36,51],[60,40],[64,51],[45,70],[44,91],[55,70],[56,91]],
        [[50,33],[50,44],[50,64],[36,48],[24,48],[64,48],[76,48],[37,72],[41,91],[63,72],[59,91]]
      ] },
    { id: 'lunge', name: '弓步蹲', cat: 'strength', part: '臀腿 · 髋稳定', eq: '无器械', level: 2, intensity: '中', view: 'side', dur: 3.2, prop: null, video: null,
      brief: '单侧下肢力量与髋部稳定的经典练习，与深蹲互补，贴近走跑登楼的发力模式。',
      cues: ['前后脚分开约一条腿长，躯干保持直立', '下落至前后膝均约 90°，前膝与脚尖同向', '后脚跟自然抬起，后膝接近地面但不砸地', '前脚发力蹬地回到起始位'],
      mistakes: ['前膝内扣或向前超过脚尖过多', '躯干前倾、弓背', '步距太小，前膝撞击胸'],
      dose: '每侧 8～12次/组 × 2～3组，隔天练习', src: ['S28'],
      frames: [
        [[53,17],[52,29],[50,50],[45,38],[44,47],[59,38],[58,47],[45,73],[36,90],[61,69],[70,91]],
        [[53,27],[52,39],[50,60],[45,48],[44,57],[59,48],[58,57],[44,86],[34,90],[62,79],[72,91]]
      ] },
    { id: 'plank', name: '平板支撑', cat: 'strength', part: '核心 · 深层稳定', eq: '垫子', level: 1, intensity: '小～中', view: 'side', dur: 3.0, prop: 'mat', video: null,
      brief: '核心「抗伸展」训练的基准动作，强化腹壁深层与肩带稳定，护腰友好。',
      cues: ['肘关节在肩正下方，前臂平放', '从头到踝一条直线：收腹、夹臀、不塌腰不撅臀', '均匀呼吸，绝不憋气', '时间不求长，高质量 20～60 秒即可'],
      mistakes: ['塌腰（腰椎压力最大的错误）', '撅臀成「帐篷」', '憋气硬撑到面红耳赤，动作变形'],
      dose: '高质量 20～60秒/组 × 2～3组，隔天练习', src: ['S28'],
      frames: [
        [[77,50],[72,53],[46,65],[70,70],[70,88],[68,69],[68,88],[30,75],[14,86],[29,76],[13,87]],
        [[77,51],[72,54],[46,66],[70,71],[70,88],[68,70],[68,88],[30,76],[14,87],[29,77],[13,88]]
      ] },
    { id: 'crunch', name: '卷腹', cat: 'strength', part: '腹部', eq: '垫子', level: 1, intensity: '小～中', view: 'side', dur: 2.8, prop: 'mat', video: null,
      brief: '腹直肌训练基础动作（指南非器械力量练习举例：仰卧起坐类），比「起坐」更护腰椎。',
      cues: ['屈膝仰卧，双手轻扶耳侧或交叉胸前', '呼气将肩胛骨卷离地面即可，腰部不整体抬起', '下落缓慢有控制，颈部放松不使劲', '想象「卷」起躯干而不是「坐」起来'],
      mistakes: ['双手抱头发力猛拉颈椎', '靠惯性甩起甩落', '幅度贪大，变成髂腰肌与腰部代偿'],
      dose: '10～15次/组 × 2～3组，隔天练习', src: ['S40', 'S28'],
      frames: [
        [[78,80],[74,79],[46,84],[72,70],[80,73],[70,69],[78,72],[24,74],[10,90],[23,75],[9,91]],
        [[63,72],[61,74],[46,84],[60,66],[68,68],[58,65],[66,67],[24,74],[10,90],[23,75],[9,91]]
      ] },
    { id: 'bridge', name: '臀桥', cat: 'strength', part: '臀 · 伸髋', eq: '垫子', level: 1, intensity: '小～中', view: 'side', dur: 3.0, prop: 'mat', video: null,
      brief: '臀大肌激活与伸髋力量的入门动作，对久坐塌臀、腰部代偿人群尤其友好。',
      cues: ['屈膝仰卧，双脚踩实与髋同宽', '呼气臀部发力抬起，至肩—髋—膝一条线', '顶端夹臀保持 1～2 秒', '缓慢下落，脊柱逐节放回垫面'],
      mistakes: ['顶得过高、腰椎过伸反弓', '用腰部代偿而不是臀部发力', '双脚离臀部太远，变成腘绳肌硬拽'],
      dose: '10～15次/组 × 2～3组，隔天练习', src: ['S28'],
      frames: [
        [[80,84],[76,83],[46,86],[58,79],[61,88],[56,78],[59,87],[24,72],[12,90],[23,73],[11,91]],
        [[80,84],[76,83],[44,72],[55,78],[58,86],[53,77],[56,85],[22,72],[10,90],[21,73],[9,91]]
      ] },
    { id: 'ohp', name: '哑铃肩上推举', cat: 'strength', part: '肩 · 上肢推', eq: '哑铃', level: 2, intensity: '中', view: 'front', dur: 3.2, prop: 'dumbbell', video: null,
      brief: '指南「器械力量练习」（哑铃类）示例动作，练肩部与上肢推起力量。',
      cues: ['坐姿靠背或站姿核心收紧，哑铃举至肩侧，掌心向前', '垂直上推至手臂接近伸直（不锁肘），哑铃在头顶微靠前', '下放慢速、有控制地回到肩侧', '选能标准完成 10～15 次的重量（10～20RM 口径）'],
      mistakes: ['站姿塌腰借力（改坐姿靠背推举）', '轨迹前后晃动、推成「斜线」', '重量过大靠蹬腿甩起'],
      dose: '8～12次/组 × 2～3组，组间休息 1～2 分钟，隔天练习', src: ['S40'],
      frames: [
        [[50,17],[50,29],[50,50],[34,44],[38,30],[66,44],[62,30],[45,70],[44,91],[55,70],[56,91]],
        [[50,17],[50,29],[50,50],[40,22],[40,9],[60,22],[60,9],[45,70],[44,91],[55,70],[56,91]]
      ] },
    /* —— 牵拉练习 —— */
    { id: 'sitreach', name: '坐位体前屈', cat: 'stretch', part: '大腿后侧 · 下背', eq: '无器械', level: 1, intensity: '小', view: 'side', dur: 3.6, prop: 'box', video: null,
      brief: '《国家体育锻炼标准》柔韧素质测验项目：静态牵拉腘绳肌与下背部，也用于日常柔韧练习。',
      cues: ['坐姿双腿伸直并拢，脚尖回勾', '呼气向前缓慢伸手，到「明显牵拉感但不疼」的位置', '保持均匀呼吸，静态保持', '腰背自然伸直，不必强求碰到脚尖'],
      mistakes: ['弹震式猛压，一颠一颠够脚尖', '憋气硬掰', '为追求距离过度弓背'],
      dose: '静态保持 10～30秒/次 × 3次；牵拉练习每周 ≥5天，每天 5～10 分钟', src: ['S43', 'S40'],
      frames: [
        [[36,44],[35,56],[34,75],[45,60],[55,64],[44,62],[54,66],[56,77],[76,90],[55,78],[75,91]],
        [[54,68],[46,66],[34,75],[62,74],[77,84],[61,76],[76,86],[56,77],[76,90],[55,78],[75,91]]
      ] },
    { id: 'hamstretch', name: '正压腿', cat: 'stretch', part: '大腿后侧 · 髋', eq: '栏杆/台阶', level: 1, intensity: '小', view: 'side', dur: 3.6, prop: 'bar', video: null,
      brief: '指南静力性牵拉示例动作（正压腿、侧压腿、压肩同类），适合放在准备与放松活动阶段。',
      cues: ['支撑腿脚尖朝正前方，膝不超伸', '抬腿放在约髋高的稳固支撑物上，脚尖回勾', '髋部摆正，呼气时躯干向腿方向缓慢贴近', '有牵拉感即可，静态保持'],
      mistakes: ['髋部歪转「用鼻子找膝盖」', '支撑脚外翻站不稳', '弹震式下压求幅度'],
      dose: '每侧静态保持 10～30秒 × 2～3次；与侧压腿、压肩等组合成 5～10 分钟牵拉', src: ['S40'],
      frames: [
        [[48,18],[49,30],[50,52],[56,42],[66,47],[58,44],[66,50],[68,52],[84,45],[52,70],[54,91]],
        [[65,38],[57,36],[50,52],[70,42],[80,44],[68,46],[78,48],[68,52],[84,45],[52,70],[54,91]]
      ] },
    /* —— 中国传统运动方式 · 健身气功八段锦（总局审定标准功法） —— */
    { id: 'b1', name: '八段锦·两手托天理三焦', cat: 'taichi', part: '全身 · 三焦', eq: '无器械', level: 1, intensity: '小～中', view: 'front', dur: 6.0, prop: null,
      video: { name: '总局·八段锦官方教学（科学健身指导）', url: 'https://www.sport.gov.cn/n4/n24581921/n24581923/n24581897/c24588542/content.html' },
      brief: '八段锦第一式：两手上托对拔拉长，传统认为理三焦气机。总局健身气功管理中心审定功法（2003）。',
      cues: ['两手腹前十指交叉，掌心向上', '上托至胸前翻掌，掌跟用力向天，头微后仰目视手背', '配合吸气充分上撑，保持片刻', '两臂经体侧缓缓下落，呼气还原'],
      mistakes: ['耸肩憋气', '上托敷衍、掌跟不用力', '速度过快，呼吸配合脱节'],
      dose: '每式做 6 次；整套每次 1～2 遍，每周 4～7 天，动作与呼吸配合', src: ['S41'],
      frames: [
        [[50,18],[50,30],[50,51],[38,52],[46,58],[62,52],[54,58],[45,68],[42,91],[55,68],[58,91]],
        [[50,15],[50,27],[50,48],[42,19],[45,7],[58,19],[55,7],[46,65],[43,91],[54,65],[57,91]]
      ] },
    { id: 'b2', name: '八段锦·左右开弓似射雕', cat: 'taichi', part: '胸背 · 上肢', eq: '无器械', level: 2, intensity: '小～中', view: 'front', dur: 8.0, prop: null,
      video: { name: '总局·八段锦官方教学（科学健身指导）', url: 'https://www.sport.gov.cn/n4/n24581921/n24581923/n24581897/c24588542/content.html' },
      brief: '第二式：马步开弓，扩胸展肩，传统认为强心肺、畅气机。',
      cues: ['两脚开立缓缓屈膝成马步（量力，膝盖不超脚尖）', '一手向侧缓缓推出如推山，一手拉至胸前如拉弓弦', '扩胸吸气，目视推手方向', '收回换边，左右交替'],
      mistakes: ['膝盖内扣、超过脚尖', '塌腰撅臀', '耸肩、速度过快'],
      dose: '左右各 3 次；整套每次 1～2 遍', src: ['S41'],
      frames: [
        [[50,17],[50,29],[50,56],[38,44],[47,40],[62,44],[53,40],[40,73],[36,91],[60,73],[64,91]],
        [[45,17],[48,29],[50,56],[28,37],[15,36],[66,42],[55,38],[36,73],[30,91],[64,73],[70,91]],
        [[50,17],[50,29],[50,56],[38,44],[47,40],[62,44],[53,40],[40,73],[36,91],[60,73],[64,91]],
        [[55,17],[52,29],[50,56],[34,42],[45,38],[72,37],[85,36],[36,73],[30,91],[64,73],[70,91]]
      ] },
    { id: 'b3', name: '八段锦·调理脾胃须单举', cat: 'taichi', part: '脾胃 · 躯干', eq: '无器械', level: 1, intensity: '小～中', view: 'front', dur: 8.0, prop: null,
      video: { name: '总局·八段锦官方教学（科学健身指导）', url: 'https://www.sport.gov.cn/n4/n24581921/n24581923/n24581897/c24588542/content.html' },
      brief: '第三式：一手上托一手下按，上下对拔拉伸躯干两侧，传统认为调理脾胃。',
      cues: ['一手经面前向上托至头顶，翻掌掌心向天', '另一手沿体侧下按，掌心向地，指尖向前', '两臂充分对拔拉长，躯干拉伸感明显', '收回至腹前，左右交换'],
      mistakes: ['上托手臂耸肩', '下按手松懈不充分', '身体歪斜、低头'],
      dose: '左右各 3 次；整套每次 1～2 遍', src: ['S41'],
      frames: [
        [[50,17],[50,29],[50,50],[39,50],[46,56],[61,50],[54,56],[45,70],[44,91],[55,70],[56,91]],
        [[50,17],[50,29],[50,50],[37,24],[40,9],[63,45],[62,57],[45,70],[44,91],[55,70],[56,91]],
        [[50,17],[50,29],[50,50],[39,50],[46,56],[61,50],[54,56],[45,70],[44,91],[55,70],[56,91]],
        [[50,17],[50,29],[50,50],[37,45],[38,57],[63,24],[60,9],[45,70],[44,91],[55,70],[56,91]]
      ] },
    { id: 'b4', name: '八段锦·五劳七伤往后瞧', cat: 'taichi', part: '颈肩 · 脊柱', eq: '无器械', level: 1, intensity: '小', view: 'front', dur: 5.0, prop: null,
      video: { name: '总局·八段锦官方教学（科学健身指导）', url: 'https://www.sport.gov.cn/n4/n24581921/n24581923/n24581897/c24588542/content.html' },
      brief: '第四式：转头后瞧配合两臂外旋，传统认为消除「五劳七伤」，舒缓颈肩。',
      cues: ['两臂自然下垂缓缓外旋，掌心转向外', '头缓缓向左（右）后方转，目视后方，下颌微收', '躯干保持正直不歪斜', '缓缓转正还原，左右交替'],
      mistakes: ['转速过快、幅度过大甩头', '耸肩挺胸', '只转头不配合两臂外旋'],
      dose: '左右各 3～4 次；颈椎病急性期不做过度转头', src: ['S41'],
      frames: [
        [[50,17],[50,29],[50,50],[40,40],[36,52],[60,40],[64,52],[45,70],[44,91],[55,70],[56,91]],
        [[58,17],[51,29],[50,50],[37,41],[31,53],[63,41],[69,53],[45,70],[44,91],[55,70],[56,91]]
      ] },
    { id: 'b5', name: '八段锦·摇头摆尾去心火', cat: 'taichi', part: '腰髋 · 脊柱', eq: '无器械', level: 2, intensity: '小～中', view: 'front', dur: 6.0, prop: null,
      video: { name: '总局·八段锦官方教学（科学健身指导）', url: 'https://www.sport.gov.cn/n4/n24581921/n24581923/n24581897/c24588542/content.html' },
      brief: '第五式：马步下扶膝，头与尾闾相对摆动，传统认为去心火、宁心神，活动腰脊柱。',
      cues: ['马步下蹲，两掌扶于大腿上方', '以腰为轴，头与臀部做相对的弧线摆动', '目随头动，呼吸自然', '幅度由小到大，量力而行'],
      mistakes: ['膝盖超脚尖或内扣', '用颈椎猛甩头', '幅度过大失去重心'],
      dose: '左右各 3 次；膝关节炎者减小幅度或改高位马步', src: ['S41'],
      frames: [
        [[38,35],[42,41],[54,58],[42,56],[44,72],[58,54],[60,72],[38,74],[34,91],[62,74],[66,91]],
        [[62,35],[58,41],[46,58],[42,54],[40,72],[58,56],[60,72],[38,74],[34,91],[62,74],[66,91]]
      ] },
    { id: 'b6', name: '八段锦·两手攀足固肾腰', cat: 'taichi', part: '腰背 · 腿后侧', eq: '无器械', level: 2, intensity: '小～中', view: 'front', dur: 7.0, prop: null,
      video: { name: '总局·八段锦官方教学（科学健身指导）', url: 'https://www.sport.gov.cn/n4/n24581921/n24581923/n24581897/c24588542/content.html' },
      brief: '第六式：躯干前屈攀足，传统认为固肾壮腰，同时牵拉腰背与腿后侧。',
      cues: ['两臂上举后旋，上身缓缓前俯', '双手沿脊柱两侧下行至臀、沿腿后侧滑向脚背', '抬头目视前下方片刻，再低头攀足', '膝尽量伸直（量力），起身时先抬头缓慢直立'],
      mistakes: ['猛然起身引起头晕', '屈膝弯腰代偿', '用爆发力下压'],
      dose: '6 次；腰椎间盘突出急性期不做', src: ['S41'],
      frames: [
        [[50,15],[50,28],[50,52],[38,45],[44,51],[62,45],[56,51],[46,72],[44,91],[54,72],[56,91]],
        [[50,70],[50,58],[50,52],[42,74],[44,86],[58,74],[56,86],[46,72],[44,91],[54,72],[56,91]]
      ] },
    { id: 'b7', name: '八段锦·攒拳怒目增气力', cat: 'taichi', part: '全身发力', eq: '无器械', level: 2, intensity: '中', view: 'front', dur: 8.0, prop: null,
      video: { name: '总局·八段锦官方教学（科学健身指导）', url: 'https://www.sport.gov.cn/n4/n24581921/n24581923/n24581897/c24588542/content.html' },
      brief: '第七式：马步攒拳冲出，瞪目聚神，传统认为激发肝气、增力气，是八段锦中的「力量练习」。',
      cues: ['马步抱拳于腰侧，拳心向上', '一拳缓缓向前冲出，前臂内旋拳眼朝上，瞪目视拳', '出拳配合呼气，收回配合吸气', '左右交替，收拳回腰间'],
      mistakes: ['速度过快成「打架」', '耸肩、身体歪斜借力', '憋气'],
      dose: '左右各 3 次；整套每次 1～2 遍', src: ['S41'],
      frames: [
        [[50,26],[50,38],[50,58],[36,50],[42,53],[64,50],[58,53],[38,74],[34,91],[62,74],[66,91]],
        [[50,26],[50,38],[50,58],[36,50],[42,53],[66,38],[82,38],[38,74],[34,91],[62,74],[66,91]],
        [[50,26],[50,38],[50,58],[36,50],[42,53],[64,50],[58,53],[38,74],[34,91],[62,74],[66,91]],
        [[50,26],[50,38],[50,58],[34,38],[18,38],[64,50],[58,53],[38,74],[34,91],[62,74],[66,91]]
      ] },
    { id: 'b8', name: '八段锦·背后七颠百病消', cat: 'taichi', part: '足踝 · 全身', eq: '无器械', level: 1, intensity: '小', view: 'front', dur: 4.5, prop: null,
      video: { name: '总局·八段锦官方教学（科学健身指导）', url: 'https://www.sport.gov.cn/n4/n24581921/n24581923/n24581897/c24588542/content.html' },
      brief: '收势第八式：脚跟提起再下落轻颠七次，传统认为震荡周身、百脉调和，收功放松。',
      cues: ['脚跟尽力提起，头向上顶，稍停', '两脚跟下落，轻震地面，全身放松', '共颠七次', '动作与呼吸配合，颠落时呼气'],
      mistakes: ['下落过重「砸」得头震荡', '憋气', '脚跟提起时身体前倾失稳'],
      dose: '颠 7 次收功；整套八段锦每次 1～2 遍', src: ['S41'],
      frames: [
        [[50,13],[50,25],[50,45],[40,36],[37,47],[60,36],[63,47],[47,64],[45,89],[53,64],[55,89]],
        [[50,17],[50,29],[50,50],[40,40],[37,51],[60,40],[63,51],[46,68],[44,91],[54,68],[56,91]]
      ] }
  ],

  /* ---------- 家常食谱（第 9 章）：7 份营养均衡的早中晚餐 ----------
     设计原则：每餐覆盖「主食＋蛋白质＋蔬菜」，贴合膳食宝塔结构；
     食材给克数、步骤给火候与时间，均为家常可复刻做法。
     能量/蛋白为单份近似估算（S2 口径折算），供参考。 */
  RECIPES: [
    { id: 'r1', meal: '早餐', name: '燕麦牛奶粥 · 水煮蛋 · 拍黄瓜', time: '10 分钟', difficulty: '零失败',
      ingredients: [['快熟燕麦片', '40g'], ['牛奶', '250ml'], ['鸡蛋', '1 个（约50g）'], ['黄瓜', '100g'], ['蒜', '1 瓣'], ['生抽', '5ml（约1茶匙）'], ['香醋', '5ml'], ['香油', '2 滴']],
      steps: [
        '鸡蛋冷水下锅，水开后转中火煮 6–7 分钟（溏心至全熟之间），捞出过凉水剥壳。',
        '小锅倒入牛奶与燕麦片，小火煮 2–3 分钟并不停搅拌，至浓稠冒小泡即关火（微波炉高火 90 秒亦可）。',
        '煮粥期间：黄瓜洗净用刀背拍裂，切小段；蒜压成蓉。',
        '黄瓜加蒜末、生抽、香醋、几滴香油拌匀装盘。粥、蛋、黄瓜一起上桌。'
      ],
      tips: '控盐关键：生抽只放 1 茶匙且不再加盐；粥不再加糖——想甜可配几粒葡萄干。',
      nutrition: '整餐约 350 kcal、蛋白质 18g：覆盖全谷物（宝塔第1层）＋奶（第4层）＋蛋（第3层）＋蔬菜（第2层），10 分钟内完成。',
      pairs: ['oat', 'milk', 'egg'], disease_tags: ['t2dm', 'dyslipidemia'] },
    { id: 'r2', meal: '早餐', name: '蔬菜鸡蛋软饼', time: '15 分钟', difficulty: '简单',
      ingredients: [['全麦面粉', '50g'], ['鸡蛋', '2 个'], ['胡萝卜', '50g（擦丝）'], ['菠菜', '50g（焯水挤干切末）'], ['牛奶或清水', '80ml'], ['盐', '1g'], ['食用油', '5g']],
      steps: [
        '胡萝卜擦细丝，菠菜入沸水烫 15 秒捞出挤干切碎（去草酸）。',
        '全麦粉加牛奶搅成无颗粒糊，打入鸡蛋搅匀，加盐调味。',
        '拌入胡萝卜丝与菠菜末，静置 3 分钟让面粉吸水。',
        '平底锅刷薄油（约3g），中火烧热转小火，倒入一半糊摊成圆饼。',
        '底面定型微黄（约 2 分钟）后翻面，再煎 1.5–2 分钟至熟。两份糊做两张饼。'
      ],
      tips: '翻面前确认底面完全定型再动铲，不易破；搭配一杯牛奶或无糖豆浆补足蛋白质。',
      nutrition: '两张饼约 380 kcal、蛋白质 16g：全麦主食＋双蛋蛋白＋双色蔬菜；β-胡萝卜素为脂溶性，煎制中的少量油正好助吸收。',
      pairs: ['egg', 'carrot', 'spinach'], disease_tags: ['t2dm', 'obesity'] },
    { id: 'r3', meal: '午餐', name: '番茄炖牛腩 · 糙米饭 · 白灼西兰花', time: '90 分钟（高压锅 35 分钟）', difficulty: '中等',
      ingredients: [['牛腩', '300g'], ['番茄', '2 个（约300g）'], ['洋葱', '50g'], ['姜', '3 片'], ['八角', '1 小瓣（可选）'], ['番茄酱', '10g（无添加糖款）'], ['盐', '2g'], ['糙米', '40g＋大米 40g'], ['西兰花', '200g'], ['食用油', '8g']],
      steps: [
        '糙米提前浸泡 1 小时，与大米混合按 1:1.2 水量煮饭。',
        '牛腩切 3cm 块，冷水下锅加 1 片姜，水开撇沫捞出洗净。',
        '番茄顶划十字，开水烫 30 秒去皮切大块；洋葱切丝。',
        '锅中 8g 油中火炒香洋葱与姜片，下番茄块炒至软烂出汁，加番茄酱炒匀。',
        '下牛腩加热水没过食材（一次性加足），大火烧开转小火加盖炖 80 分钟，或高压锅上气后 22 分钟。',
        '出锅前加盐调味；西兰花沸水焯 90 秒捞出，淋几滴生抽即可配餐。'
      ],
      tips: '番茄炒出汁再加肉，茄红素释放更充分；炖肉中途不添冷水（蛋白质骤缩变柴）。',
      nutrition: '单份约 550 kcal、蛋白质 32g：牛肉血红素铁＋番茄茄红素（加油烹调促吸收）＋全谷物主食＋深绿蔬菜，覆盖宝塔全部五层。',
      pairs: ['tomato', 'beef', 'broccoli', 'brownrice'], disease_tags: ['anemia', 't2dm'] },
    { id: 'r4', meal: '午餐', name: '清蒸鲈鱼 · 杂粮饭 · 蒜蓉油麦菜', time: '25 分钟', difficulty: '简单',
      ingredients: [['鲈鱼（或三文鱼段）', '1 条（约500g）'], ['葱', '2 根'], ['姜', '1 块'], ['蒸鱼豉油', '10ml'], ['食用油', '6g'], ['杂粮米（糙米/燕麦米/小米混合）', '80g'], ['油麦菜', '200g'], ['蒜', '2 瓣']],
      steps: [
        '杂粮米浸泡 30 分钟后煮饭（水量比白米略多一成）。',
        '鱼去鳞去鳃洗净，两面各斜划 2 刀；姜切片塞入刀缝与鱼腹，腌 10 分钟。',
        '蒸锅水烧开后再放鱼，大火足汽蒸 8 分钟（500g 为准，每多 100g 加 1 分钟），关火虚蒸 2 分钟。',
        '倒掉盘中腥水、去掉姜片，鱼身铺葱丝姜丝。',
        '取 6g 油烧至冒青烟（八九成热），浇在葱丝上激香，沿盘边淋蒸鱼豉油。',
        '油麦菜洗净切段：2g 底油爆香蒜末，大火快炒 40 秒至断生，加 1g 盐出锅。'
      ],
      tips: '蒸鱼水开再上锅、计时从足汽算起，是嫩而不腥的关键；豉油含钠，不再另加盐。',
      nutrition: '单份约 520 kcal、蛋白质 35g：清蒸保留 n-3 脂肪酸且用油少（整餐油约 10g，宝塔上限 25–30g 的 1/3）；鱼＋杂粮＋绿叶菜结构均衡。',
      pairs: ['salmon', 'brownrice'], disease_tags: ['dyslipidemia', 'hypertension'] },
    { id: 'r5', meal: '晚餐', name: '香菇蒸滑鸡 · 二米饭 · 醋溜白菜', time: '40 分钟（含腌制）', difficulty: '简单',
      ingredients: [['去骨鸡腿肉', '250g'], ['干香菇', '6 朵'], ['姜', '3 片切丝'], ['生抽', '10ml'], ['淀粉', '5g'], ['香油', '2ml'], ['小米', '40g＋大米 40g'], ['大白菜', '200g'], ['香醋', '10ml'], ['干辣椒（可选）', '1 个'], ['食用油', '8g'], ['盐', '1.5g']],
      steps: [
        '干香菇温水泡发 20 分钟切片（泡菇水留用）；小米与大米同煮成二米饭。',
        '鸡腿肉切 2cm 块，加姜丝、生抽、淀粉、香油抓匀，腌 15 分钟。',
        '鸡块与香菇片拌匀平铺深盘，水开后上锅大火蒸 15 分钟至熟透。',
        '蒸制期间处理白菜：帮、叶分开切片。',
        '锅中 8g 油小火煸香干辣椒段，先下白菜帮大火炒 1 分钟，再下菜叶炒至塌软。',
        '沿锅边烹入香醋，加盐翻匀立刻出锅（保留脆感与醋香）。'
      ],
      tips: '腌肉加淀粉锁水是「滑嫩」的全部秘密；泡菇水静置沉淀后可用来煮饭或兑汁，鲜味不浪费。',
      nutrition: '单份约 500 kcal、蛋白质 30g：蒸制用油仅 2ml，整餐油盐都留有余量；菌菇鲜味物质可部分替代盐。',
      pairs: ['chickenbreast', 'shiitake'], disease_tags: ['hypertension', 'fitness'] },
    { id: 'r6', meal: '晚餐', name: '鸭血豆腐汤 · 凉拌菠菜 · 全麦馒头', time: '20 分钟', difficulty: '简单',
      ingredients: [['鸭血', '200g'], ['北豆腐', '150g'], ['菠菜', '150g'], ['姜', '2 片'], ['香油', '2ml'], ['盐', '1.5g'], ['白胡椒粉（可选）', '少许'], ['全麦馒头', '1 个（约80g）'], ['蒜', '1 瓣'], ['生抽', '5ml'], ['香醋', '5ml']],
      steps: [
        '菠菜洗净，沸水焯 20 秒捞出过凉（去除大部分草酸），挤干切段，加蒜末、生抽、香醋、两滴香油拌匀。',
        '鸭血切 1.5cm 方块，冷水下锅加 1 片姜，水开后再煮 1 分钟捞出（去腥定型）。',
        '北豆腐切块，与鸭血、姜片放入汤锅，加 600ml 热水，中火煮 6–8 分钟。',
        '加盐与白胡椒粉调味，关火淋香油。',
        '全麦馒头蒸热或烤脆，配汤同食。'
      ],
      tips: '选正规预包装鸭血；此汤是经典的「补铁组合」——鸭血血红素铁吸收率高，菠菜焯水后草酸已去大半。',
      nutrition: '单份约 420 kcal、蛋白质 26g：高铁（鸭血＋菠菜）、高钙（北豆腐）低脂的一餐，适合缺铁性贫血与控脂人群。',
      pairs: ['duckblood', 'tofu', 'spinach'], disease_tags: ['anemia', 'osteoporosis'] },
    { id: 'r7', meal: '加餐', name: '无糖酸奶水果坚果杯', time: '5 分钟', difficulty: '零失败',
      ingredients: [['无糖酸奶', '150g'], ['猕猴桃', '1 个（约80g）'], ['蓝莓或应季水果', '50g'], ['核桃仁', '10g（约2个）'], ['熟亚麻籽粉', '5g']],
      steps: [
        '猕猴桃去皮切片，蓝莓洗净沥干。',
        '杯中依次放入酸奶、水果，撒亚麻籽粉。',
        '核桃仁掰小块撒顶，即成。'
      ],
      tips: '认准配料表只有「生牛乳＋菌种」的无糖酸奶（蛋白质 ≥2.3g/100g）；亚麻籽现磨现吃，整粒不易吸收。',
      nutrition: '约 250 kcal、蛋白质 8g：优质蛋白＋维C＋n-3（ALA）＋花青素，运动后或下午加餐均可；代替糕点甜品最划算。',
      pairs: ['yogurt', 'kiwi', 'walnut', 'flaxseed'], disease_tags: ['fitness', 'constipation'] }
  ],
  ...
  QUIZ_BANK: {
    ...
    exercise: [
      { q: '按国家体育总局《全民健身指南》，中等强度运动的心率一般在：', opts: ['80 次/分以下', '100～140 次/分', '150 次/分以上', '与心率无关'], ans: 1, exp: '指南口径：小强度一般不超过 100 次/分，中等强度 100～140 次/分，大强度超过 140 次/分；最大心率≈220−年龄，中等强度约为最大心率的 60%～80%。', src: ['S40'] },
      { q: '《全民健身指南》对力量练习的长期推荐是：', opts: ['每天练同一部位练到力竭', '每周 2～3 次，10～20RM 负荷重复 10～15 次', '只做有氧，不必练力量', '每组必须做满 100 次'], ans: 1, exp: '长期方案：每周 2～3 次（隔天），每次 8～10 种力量练习，10～20RM 负荷重复 10～15 次，每部位 2～3 组，组间休息 1～2 分钟。', src: ['S40'] },
      { q: '一次完整的体育健身活动应包括：', opts: ['直接进入大强度训练', '准备活动＋基本活动＋放松活动', '只练力量、不做放松', '拉伸到疼痛才有效'], ans: 1, exp: '指南：准备活动 5～10 分钟＋基本活动 30～60 分钟＋放松活动 5～10 分钟；准备与放松阶段正好安排快走慢跑与牵拉练习。', src: ['S40'] },
      { q: '运动中「呼吸比较急促、只能讲短句子」大概对应：', opts: ['小强度', '中等强度', '大强度（已不能交谈）', '过量危险信号，必须立即停止'], ans: 1, exp: '「说话测试」：能唱歌=小强度；能正常交流=较轻松；只能讲短句子=中等强度（约130～140次/分）；不能交谈=大强度。', src: ['S40'] },
      { q: '总局推广的健身气功·八段锦，八式之首是：', opts: ['两手托天理三焦', '摇头摆尾去心火', '背后七颠百病消', '攒拳怒目增气力'], ans: 0, exp: '八式顺序：两手托天理三焦、左右开弓似射雕、调理脾胃须单举、五劳七伤往后瞧、摇头摆尾去心火、两手攀足固肾腰、攒拳怒目增气力、背后七颠百病消。', src: ['S41'] },
      { q: '在《全民健身指南》的活动方式分类中，八段锦、太极拳属于：', opts: ['有氧运动', '球类运动', '中国传统运动方式', '器械力量练习'], ans: 2, exp: '指南将体育活动方式分为有氧运动、力量练习、球类运动、中国传统运动方式、牵拉练习五大类；八段锦、太极拳（剑）、五禽戏、易筋经等属传统运动方式。', src: ['S40', 'S41'] },
      { q: '第九套广播体操由国家体育总局于哪一年发布？', opts: ['1997 年', '2005 年', '2011 年', '2021 年'], ans: 2, exp: '2011 年 8 月 8 日（全民健身日）发布：预备节原地踏步＋8 节徒手动作（伸展、扩胸、踢腿、体侧、体转、腹背、跳跃、整理），总时长约 4 分 15 秒。', src: ['S42'] },
      { q: '《国家体育锻炼标准》（2013 年）测验的五类身体素质是：', opts: ['身高、体重、肺活量、视力、血压', '速度、力量、耐力、灵敏、柔韧', '平衡、协调、反应、心肺、体脂', '只考跑步和跳远'], ans: 1, exp: '适用于 6～69 周岁健康公民、按年龄分组：如速度（30/50米跑、30秒跳绳）、耐力（300～1000米跑）、力量（俯卧撑、仰卧起坐等）、柔韧（坐位体前屈）、灵敏（往返跑等）。', src: ['S43'] }
    ]
  }
};
